...
;		openr, 1, strmid(fil,0,xlc(fil))
      ...
      printf, 1,  lls[i].signhi, '! NHI sig', format='(f9.4,f9.4,42x,a9)' 
      ...
      for j=0,lls[i].nsys-1 do begin
          ...
          printf, 1,  lls[i].systems[j].sig_alphaH, '! '+nm+' sig[a/H]', format='(f9.6,51x,a12)' 
          printf, 1,  lls[i].systems[j].flgfe,  '! '+nm+' flg_Fe', format='(i2,56x,a12)'
          printf, 1,  lls[i].systems[j].feh, '! '+nm+' [Fe/H]', format='(f9.6,51x,a10)' 
          printf, 1,  lls[i].systems[j].sig_feh, '! '+nm+' sig[Fe/H]', format='(f9.6,51x,a13)' 
          ;; VPFIT
