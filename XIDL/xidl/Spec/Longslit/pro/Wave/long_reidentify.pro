...
if keyword_set(ARC_INTER) then begin
    ...
    ;;MF 2013. to save a new solution, save tcalib in x_identify and replace that 
    ;;variable with calib here below. This will preserve the pointer. 
    ;archive_arc=arc_obj
    ;calib=fit_ref
    ;save, archive_arc, calib, filenam='dis_R1200.sav'
