pro kast_calcs2n_wrapper,wave,s2n,wvmn=wvmn,wvmx=wvmx,slitwidth=slitwidth,dichroic=dichroic, $ 
  ...
  x_initkast, str_instr, INFIL=infil, STR_TEL=str_tel, SLIT=slitwidth
...
;  if (keyword_set(binning)) then  state.str_instr[1].binning = binning
  ...
  kast_calcs2n, state.wave[0:state.nwv-1], 3, $
