...
pro fitsimul_combtemp, filename, starflux, starsig, starwave,nn0,nn, czmin, czmax, returntest
...
for i=nn0,nn do begin 
  ...
  ntemp=(size(starflux))[2]
	
  for ii=0,ntemp-1 do begin	

  mveldisp, b, bsig, bwave, starflux[*,ii], starsig[*,ii], starwave[*,ii], result, redshifts=bredshifts, czmin= czmin, czmax= czmax, klo_cut=0.016, khi_cut=0.23, maxsig=6
...
nametest=string('veldisp_simul_comb_temp_'+string(nn0,format='(i2.2)')+$
