;------------------------------------------------------------------------------
pro pca_cvstar_boss
; Written by Schlegel (right?)
; Hacked up a bit from pca_cvstar by Bolton (U. Utah) for BOSS:
;   - nkeep = 2 rather than 3
;   - run2d/run1d hard-coded along with other stuff
...
;   minuse = 3
   ...
   outfile = 'spBOSSEigenCVstar-' + mjdstr + '.fits'
;   plotfile = 'spBOSSEigenCVstar-' + mjdstr + '.ps'
