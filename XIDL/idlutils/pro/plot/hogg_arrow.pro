...
;		vectors.
PRO Hogg_ARROW, x0, y0, x1, y1, HSIZE = hsize, COLOR = color, $
                HTHICK = hthick, $
                THICK = thick, DATA = data, NORMALIZED = norm, $
                SOLID = solid, HEAD_ANGLE = head_angle
...
if n_elements(head_angle) eq 0 then head_angle= 10.0d
mcost = -cos(head_angle*!PI/180.0)
sint = sin(head_angle*!PI/180.0)
msint = - sint
