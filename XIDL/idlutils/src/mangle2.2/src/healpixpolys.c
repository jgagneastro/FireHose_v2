...
/*-----------------------------------------------------------
  get_healpix_poly: uses the HEALPix Fortran subroutine
                     pix2vecnest to construct the HEALPix
...
{
  pix2vecnest_(&nside, &pix, &(center[0]), &(center[1]), &(center[2]), &(verts[0]), &(verts[1]), &(verts[2]), &(verts[3]), &(verts[4]), &(verts[5]), &(verts[6]), &(verts[7]), &(verts[8]), &(verts[9]), &(verts[10]), &(verts[11]));
}
