...
/* Modified to handle varying number of fibers per block, and variable extraction size, for MaNGA survey */
/* Dec 2012, Brian Cherinka, Toronto */

IDL_LONG ml_trace_fweight
  (int      argc,
   void *   argv[])
{
   IDL_LONG    nx;
   ...
   for (icen=0; icen < ncen; icen ++) {
      recenter_fweight(nx, fimage[ycen[icen]], invvar[ycen[icen]], radius[icen],
