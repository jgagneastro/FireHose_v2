; MODIFIED VERSION FROM GODDARD LIBRARIES TO SKIP COMMENT LINES
; THAT START WITH HASH MARKS!  David Schlegel, 8 Sep 1997, Durham
;
pro djs_readcol,name,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15, $
...
;-
  ...
  if N_params() lt 2 then begin
     print,'Syntax - djs_readcol, name, v1, [ v2, v3,...v25, '
...
;     if strlen(temp) LT ncol then begin    ;Need at least 1 chr per output line
      if (strlen(temp) LT ncol OR temp(0) EQ '#') then begin
          ngood = ngood-1
