; $Id: int_tabulated.pro,v 1.19 2003/02/03 18:13:18 scottm Exp $
;
...
;                        Modified keyword checking and use of double
;                        precision.
;           
;-

FUNCTION mc_Int_Tabulated, X, F
...
;endif 
  ...
  ;Compute the interpolates at Xgrid.
    ...
    z = SPL_INTERP(XX, FF, SPL_INIT(XX, FF, Double = Double), $
