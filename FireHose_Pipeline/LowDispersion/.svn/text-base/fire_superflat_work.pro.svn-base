...
;-
;------------------------------------------------------------------------------
pro fire_superflat_work, filenames, superpixflatfile, superillum=superillumflatfile $
                    , slitfile = slitfile $
...
;         If slitfile is provided generate slitmask 
           IF (keyword_set(slitfile)) THEN $
             tset_slits_orig = xmrdfits(slitfile[0], 1 $
         ...
         FOR slitid = 1L, nslit DO BEGIN
          ...
          if (ngood GT 0) then begin
              ...
              if keyword_set(temppillum0) then begin
                 illum_set = xmrdfits(tempillum0[0], slitid, /silent)
