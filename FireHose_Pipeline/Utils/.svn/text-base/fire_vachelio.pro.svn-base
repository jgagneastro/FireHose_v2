pro mage_vachelio, obj_strct, head=head
   ...
   hdr = headfits(obj_strct[0].img_fil)
...
;;  DO NOT PERFORM AIR TO VAC CORRECTION
;;  We are using the vacuum OH wavelengths from Rousselot
;;  Also, FIRE is in vacuum already.
      if (0) then begin
   ...
   if (keyword_set(head)) then begin
      ...
      msg = 'FIRE_pipe: Vac/helio applied for '+filenm+', helio = '+strtrim(helio_corr,2)+' km/s'
