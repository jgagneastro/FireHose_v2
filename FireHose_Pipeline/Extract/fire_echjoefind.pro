...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
function fire_echjoefind, img, sciivar, waveimg,gdtrc, slit_edg $
                          , FITSTD = fitstd $
	...
	func_name = 'fire_echjoefind'

  if  N_params() LT 4  then begin 
      print, 'Syntax - ' + $
             'ostr = fire_echjoefind( img, var, gdtrc, slit_edg, cbin )  [v1.0]'
      return, -1
  endif 
...
;; boxcar extraction
  ...
  IF nbad_sn NE 0 THEN BEGIN
     ...
     print,'                                 ' + $
              fire_string(31 - (objstruct[bad].slitid - 1))    
  ENDIF
